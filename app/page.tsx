      ...
      <div className="font-Poppins bg-background min-h-screen scroll-smooth">
        <div className="flex items-center justify-center px-4 sm:px-6 md:px-10 lg:px-40">
          <div className="flex flex-col items-center text-center mt-10 md:mt-20 max-w-6xl w-full">
            ...
            <p className="text-base sm:text-lg md:text-xl max-w-2xl mx-auto mt-4 text-gray-600">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-8 mt-10 w-full">
              ...
              {/* Student */}
              <div className="group bg-white border-blue-300 hover:border-blue-700 hover:shadow-blue-300 hover:shadow-md border flex flex-col items-center justify-center rounded-2xl p-4 sm:p-5 md:p-6 cursor-pointer transition-all duration-300">
                <div className="text-center my-4">
                  ...
                  <h1 className="mt-6 text-xl sm:text-2xl font-semibold">Student</h1>
                  ...
                  <div className="flex flex-col mt-5">
                    <ul className="list-disc pl-5 text-start text-sm sm:text-md marker:text-blue-600 space-y-3">
              ...
              {/* Adviser */}
              <div className="group bg-white border-green-300 hover:border-green-700 hover:shadow-green-300 hover:shadow-md border flex flex-col items-center justify-center rounded-2xl p-4 sm:p-5 md:p-6 cursor-pointer transition-all duration-300">
                <div className="text-center my-4">
                  ...
                  <h1 className="mt-6 text-xl sm:text-2xl font-semibold">Thesis Adviser</h1>
                  <p className="mt-3 text-sm sm:text-md text-gray-600">
                    Review student works, provide feedbacks, and guide project development.
                  </p>
                  <div className="flex flex-col mt-5">
                    <ul className="list-disc pl-5 text-start text-sm sm:text-md marker:text-green-600 space-y-3">
              ...
              {/* Instructor */}
              <div className="group bg-white border-purple-300 hover:border-purple-700 hover:shadow-purple-300 hover:shadow-md border flex flex-col items-center justify-center rounded-2xl p-4 sm:p-5 md:p-6 cursor-pointer transition-all duration-300">
                <div className="text-center my-4">
                  ...
                  <h1 className="mt-6 text-xl sm:text-2xl font-semibold">Subject Instructor</h1>
                  <p className="mt-3 text-sm sm:text-md text-gray-600">
                    Create teams, assign tasks, and oversee multiple projects.
                  </p>
                  <div className="flex flex-col mt-5">
                    <ul className="list-disc pl-5 text-start text-sm sm:text-md marker:text-purple-600 space-y-3">
            ...
            <div className="flex flex-col items-center mt-10 max-w-2xl bg-white rounded-lg p-6 border border-gray-200 shadow-md">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="bg-blue-50 p-4 rounded-lg flex flex-col items-center gap-1">
                  <h1 className="text-md md:text-sm font-semibold text-blue-900">Colaboration</h1>
                  <p className="text-blue-700 text-md md:text-sm">Real-time feedback and comments</p>
                </div>
                <div className="bg-green-50 p-4 rounded-lg flex flex-col items-center gap-1">
                  <h1 className="text-md md:text-sm font-semibold text-green-900">Progress Tracking</h1>
                  <p className="text-green-700 text-md md:text-sm">Monitor every project phase</p>
                </div>
                <div className="bg-purple-50 p-4 rounded-lg flex flex-col items-center gap-1">
                  <h1 className="text-md md:text-sm font-semibold text-purple-900">Searchable Archive</h1>
                  <p className="text-purple-700 text-md md:text-sm">Easily find and access past projects</p>
                </div>
              </div>
            </div>
