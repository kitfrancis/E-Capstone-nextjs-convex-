          ...
          <div className="h-auto bg-sidebar my-6 rounded-xl border border-sidebar-accent dark:border-sidebar">
            ...
            <div className="mx-6 my-6">
              ...
              <div className="flex flex-col gap-1 mt-4">
                ...
                <Label className="mt-2 font-semibold text-base">Student No.</Label>
                <Input
                  type="text"
                  value={studentNo}
                ...
                <Select value={program} onValueChange={setProgram}>
                  <SelectTrigger className="bg-sidebar-accent border text-foreground text-sm h-9 sm:h-10">
                ...
                <Label className="mt-2 font-semibold text-base">Section</Label>
